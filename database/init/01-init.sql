...
BEGIN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'users') THEN
       ...
       -- 상품 데이터 (적절한 이미지로 수정)
        ...
        -- 스마트폰 (5)
        ('iPhone 15 Pro', 5, 1500000.00, 'Apple', '최신 아이폰 15 Pro 256GB', 50, 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=600&h=600&fit=crop'),
        ('Samsung Galaxy S24', 5, 1200000.00, 'Samsung', '삼성 갤럭시 S24 256GB', 45, 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=600&h=600&fit=crop'),
        ('Google Pixel 8', 5, 1100000.00, 'Google', 'Google Pixel 8 128GB', 30, 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=600&h=600&fit=crop'),
        ('OnePlus 12', 5, 1000000.00, 'OnePlus', 'OnePlus 12 256GB', 25, 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&h=600&fit=crop'),
        ('Xiaomi 14', 5, 900000.00, 'Xiaomi', 'Xiaomi 14 256GB', 40, 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=600&h=600&fit=crop'),

        -- 노트북 (6)
        ('MacBook Pro 14인치', 6, 2800000.00, 'Apple', 'M3 칩 탑재 맥북 프로 14인치', 30, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&h=600&fit=crop'),
        ('LG Gram 노트북', 6, 1800000.00, 'LG', '초경량 LG Gram 15인치 노트북', 25, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600&h=600&fit=crop'),
        ('Samsung Galaxy Book', 6, 1600000.00, 'Samsung', 'Samsung Galaxy Book Pro 360', 20, 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=600&h=600&fit=crop'),
        ('Dell XPS 13', 6, 2000000.00, 'Dell', 'Dell XPS 13 13인치 노트북', 15, 'https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?w=600&h=600&fit=crop'),
        ('HP Spectre x360', 6, 1900000.00, 'HP', 'HP Spectre x360 13인치', 18, 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=600&h=600&fit=crop'),

        -- 태블릿 (7)
        ('iPad Air', 7, 800000.00, 'Apple', 'iPad Air 5세대 64GB', 40, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop'),
        ('Samsung Galaxy Tab S9', 7, 700000.00, 'Samsung', 'Samsung Galaxy Tab S9 11인치', 35, 'https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=600&h=600&fit=crop'),
        ('iPad Pro 12.9', 7, 1500000.00, 'Apple', 'iPad Pro 12.9인치 M2 칩', 20, 'https://images.unsplash.com/photo-1561154464-82e9adf32764?w=600&h=600&fit=crop'),
        ('Microsoft Surface Pro', 7, 1200000.00, 'Microsoft', 'Microsoft Surface Pro 9', 15, 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=600&h=600&fit=crop'),
        ('Lenovo Tab P11', 7, 400000.00, 'Lenovo', 'Lenovo Tab P11 11인치', 50, 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=600&h=600&fit=crop'),
        ...
        ('남성 운동복', 8, 65000.00, 'Adidas', '남성용 트레이닝 세트', 70, 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=600&fit=crop'),
        ('남성 양말', 8, 8000.00, 'Stance', '남성용 면 양말 5켤레', 200, 'https://www.costco.co.kr/medias/sys_master/images/hf1/heb/239458539601950.jpg'),

        -- 여성의류 (9)
        ('여성 원피스', 9, 45000.00, 'ZARA', '여성용 여름 원피스', 80, 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=600&h=600&fit=crop'),
        ('여성 블라우스', 9, 35000.00, 'H&M', '여성용 실크 블라우스', 60, 'https://img.gncostyle.com/uploadNew/product/ti/246/BL/T246MBL149W/T246MBL149W_1.JPG'),
        ...
        ('여성 코트', 9, 180000.00, 'Massimo Dutti', '여성용 울 코트', 20, 'https://sitem.ssgcdn.com/63/01/76/item/1000530760163_i1_750.jpg'),
        ('여성 청바지', 9, 50000.00, 'Levi\s', '여성용 하이웨이스트 진', 75, 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=600&h=600&fit=crop'),
        ('여성 운동복', 9, 70000.00, 'Lululemon', '여성용 요가 팬츠', 55, 'https://sitem.ssgcdn.com/42/09/02/item/1000459020942_i1_750.jpg'),
        ...
        -- 아동의류 (10)
        ('아동용 운동화', 10, 35000.00, '나이키', '아동용 운동화 사이즈 200-230', 60, 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop'),
        ('아동용 티셔츠', 10, 15000.00, '유니클로', '아동용 캐릭터 티셔츠', 120, 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=600&h=600&fit=crop'),
        ('아동용 바지', 10, 20000.00, 'Gap Kids', '아동용 면 바지', 90, 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=600&h=600&fit=crop'),
        ('아동용 후드티', 10, 25000.00, 'Adidas Kids', '아동용 후드 티셔츠', 70, 'https://images.unsplash.com/photo-1627225924765-552d49cf47ad?w=600&h=600&fit=crop'),
        ('아동용 원피스', 10, 30000.00, 'ZARA Kids', '아동용 여름 원피스', 50, 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=600&h=600&fit=crop'),

        -- 책상 (11)
        ('책상 세트', 11, 150000.00, '이케아', '책상과 의자가 포함된 세트', 20, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('스탠딩 책상', 11, 200000.00, 'Fully', '전동 스탠딩 책상', 15, 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&h=600&fit=crop'),
        ('L자 책상', 11, 180000.00, '이케아', 'L자형 컴퓨터 책상', 25, 'https://images.unsplash.com/photo-1551836022-8b2858c9c69b?w=600&h=600&fit=crop'),
        ('학생용 책상', 11, 80000.00, '이케아', '학생용 책상 세트', 40, 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=600&h=600&fit=crop'),
        ('모니터 받침대', 11, 30000.00, '이케아', '모니터 받침대', 100, 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=600&h=600&fit=crop'),

        -- 의자 (12)
        ('사무용 의자', 12, 80000.00, '허먼밀러', '인체공학적 사무용 의자', 35, 'https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=600&h=600&fit=crop'),
        ('게이밍 의자', 12, 120000.00, 'Secretlab', '게이밍 의자', 20, 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=600&h=600&fit=crop'),
        ('식탁 의자', 12, 45000.00, '이케아', '식탁용 의자 4개 세트', 30, 'https://images.unsplash.com/photo-1581539250439-c96689b516dd?w=600&h=600&fit=crop'),
        ('안락 의자', 12, 150000.00, '이케아', '안락 의자', 15, 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&h=600&fit=crop'),
        ('바 의자', 12, 25000.00, '이케아', '바 스툴', 50, 'https://images.unsplash.com/photo-1549497538-303791108f95?w=600&h=600&fit=crop'),

        -- 침대 (13)
        ('퀸사이즈 침대', 13, 300000.00, '시몬스', '퀸사이즈 침대 프레임', 15, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ('킹사이즈 침대', 13, 400000.00, '시몬스', '킹사이즈 침대 프레임', 10, 'https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=600&h=600&fit=crop'),
        ('싱글 침대', 13, 150000.00, '이케아', '싱글 침대 프레임', 25, 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=600&h=600&fit=crop'),
        ('침대 매트리스', 13, 200000.00, '시몬스', '퀸사이즈 매트리스', 20, 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=600&fit=crop'),
        ('침대 커버', 13, 50000.00, '이케아', '침대 커버 세트', 40, 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=600&h=600&fit=crop'),

        -- 과일 (14)
        ('신선한 사과 1kg', 14, 8000.00, '농협', '신선한 국내산 사과 1kg', 200, 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=600&h=600&fit=crop'),
        ('바나나 1kg', 14, 3000.00, '농협', '신선한 바나나 1kg', 300, 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&h=600&fit=crop'),
        ('오렌지 1kg', 14, 5000.00, '농협', '제철 오렌지 1kg', 150, 'https://images.unsplash.com/photo-1547514701-42782101795e?w=600&h=600&fit=crop'),
        ('포도 500g', 14, 6000.00, '농협', '샤인머스켓 500g', 100, 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?w=600&h=600&fit=crop'),
        ('딸기 400g', 14, 8000.00, '농협', '국내산 딸기 400g', 80, 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=600&h=600&fit=crop'),
        ('키위 6개', 14, 4000.00, '농협', '제철 키위 6개', 120, 'https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=600&h=600&fit=crop'),
        ('망고 2개', 14, 7000.00, '농협', '제철 망고 2개', 60, 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&h=600&fit=crop'),
        ('레몬 5개', 14, 3000.00, '농협', '신선한 레몬 5개', 200, 'https://i.namu.wiki/i/wzNjeFiFKvMr6SxgzH772VbLXgRbesDSegX8qWrHZI8WG8wv_ck1ajY4axwxs5-FThM-tGYhjhp0k5tOdMJ_6w.webp'),

        -- 채소 (15)
        ('유기농 당근 500g', 15, 3000.00, '농협', '유기농 당근 500g', 150, 'https://i.namu.wiki/i/aD0cdxkIOd7Ov4vsrdamC04cSBaqI3KLwSI8PsYoEkdkmzLOM-Ke1pu5A5cuz8UbCXLVht2JVk1l44VFCx2d2g.webp'),
        ('브로콜리 300g', 15, 4000.00, '농협', '신선한 브로콜리 300g', 100, 'https://images.unsplash.com/photo-1459411621453-7b03977f4bfc?w=600&h=600&fit=crop'),
        ('양파 1kg', 15, 2000.00, '농협', '국내산 양파 1kg', 300, 'https://images.unsplash.com/photo-1508747703725-719777637510?w=600&h=600&fit=crop'),
        ('감자 1kg', 15, 2500.00, '농협', '국내산 감자 1kg', 250, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&h=600&fit=crop'),
        ('상추 200g', 15, 1500.00, '농협', '신선한 상추 200g', 200, 'https://upload.wikimedia.org/wikipedia/commons/4/4f/Insalata_lollo_bionda.jpg'),
        ('토마토 500g', 15, 3500.00, '농협', '제철 토마토 500g', 120, 'https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=600&h=600&fit=crop'),
        ('오이 3개', 15, 2000.00, '농협', '신선한 오이 3개', 180, 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=600&h=600&fit=crop'),
        ('고구마 1kg', 15, 4000.00, '농협', '국내산 고구마 1kg', 100, 'https://i.namu.wiki/i/9av_QFbUYY-0ehSj1q7UB6CDyQm54ele3wzy0vmUQaACwsKl7PKoZ6ivDViqdmNwcv0D0HPT0TPdxDk4n7RXZA.webp'),

        -- 육류 (16)
        ('한우 등심 200g', 16, 25000.00, '농협', '프리미엄 한우 등심 200g', 50, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('돼지고기 목살 500g', 16, 8000.00, '농협', '신선한 돼지고기 목살 500g', 100, 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&h=600&fit=crop'),
        ('닭가슴살 1kg', 16, 12000.00, '농협', '무항생제 닭가슴살 1kg', 80, 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=600&h=600&fit=crop'),
        ('양고기 500g', 16, 30000.00, '농협', '프리미엄 양고기 500g', 30, 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=600&h=600&fit=crop'),
        ('오리고기 1kg', 16, 15000.00, '농협', '신선한 오리고기 1kg', 60, 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=600&h=600&fit=crop'),
        ('소고기 다짐육 500g', 16, 18000.00, '농협', '소고기 다짐육 500g', 70, 'https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=600&h=600&fit=crop'),
        ('돼지고기 삼겹살 1kg', 16, 22000.00, '농협', '돼지고기 삼겹살 1kg', 90, 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=600&h=600&fit=crop'),
        ('닭다리 1kg', 16, 10000.00, '농협', '닭다리 1kg', 110, 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=600&h=600&fit=crop');
