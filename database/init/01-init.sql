...
BEGIN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'users') THEN
        ...
        ('Google Pixel 8', 5, 1100000.00, 'Google', 'Google Pixel 8 128GB', 30, 'https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?w=600&h=600&fit=crop'),
        ('OnePlus 12', 5, 1000000.00, 'OnePlus', 'OnePlus 12 256GB', 25, 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=600&h=600&fit=crop'),
        ('Xiaomi 14', 5, 900000.00, 'Xiaomi', 'Xiaomi 14 256GB', 40, 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=600&h=600&fit=crop'),
        ...
        ('Samsung Galaxy Book', 6, 1600000.00, 'Samsung', 'Samsung Galaxy Book Pro 360', 20, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&h=600&fit=crop'),
        ('Dell XPS 13', 6, 2000000.00, 'Dell', 'Dell XPS 13 13인치 노트북', 15, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600&h=600&fit=crop'),
        ('HP Spectre x360', 6, 1900000.00, 'HP', 'HP Spectre x360 13인치', 18, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&h=600&fit=crop'),
        ...
        ('Samsung Galaxy Tab S9', 7, 700000.00, 'Samsung', 'Samsung Galaxy Tab S9 11인치', 35, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop'),
        ('iPad Pro 12.9', 7, 1500000.00, 'Apple', 'iPad Pro 12.9인치 M2 칩', 20, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop'),
        ('Microsoft Surface Pro', 7, 1200000.00, 'Microsoft', 'Microsoft Surface Pro 9', 15, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop'),
        ('Lenovo Tab P11', 7, 400000.00, 'Lenovo', 'Lenovo Tab P11 11인치', 50, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop'),
        ...
        ('남성 양말', 8, 8000.00, 'Stance', '남성용 면 양말 5켤레', 200, 'https://images.unsplash.com/photo-1586350977771-b3b0abd50c5a?w=600&h=600&fit=crop'),
        
        -- 여성의류 (9)
        ('여성 원피스', 9, 45000.00, 'ZARA', '여성용 여름 원피스', 80, 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=600&h=600&fit=crop'),
        ('여성 블라우스', 9, 35000.00, 'H&M', '여성용 실크 블라우스', 60, 'https://images.unsplash.com/photo-1564257631407-3deb25e91aa5?w=600&h=600&fit=crop'),
        ...
        ('아동용 바지', 10, 20000.00, 'Gap Kids', '아동용 면 바지', 90, 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=600&h=600&fit=crop'),
        ('아동용 후드티', 10, 25000.00, 'Adidas Kids', '아동용 후드 티셔츠', 70, 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=600&h=600&fit=crop'),
        ('아동용 원피스', 10, 30000.00, 'ZARA Kids', '아동용 여름 원피스', 50, 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=600&h=600&fit=crop'),
        
        -- 책상 (11)
        ('책상 세트', 11, 150000.00, '이케아', '책상과 의자가 포함된 세트', 20, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('스탠딩 책상', 11, 200000.00, 'Fully', '전동 스탠딩 책상', 15, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('L자 책상', 11, 180000.00, '이케아', 'L자형 컴퓨터 책상', 25, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('학생용 책상', 11, 80000.00, '이케아', '학생용 책상 세트', 40, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('모니터 받침대', 11, 30000.00, '이케아', '모니터 받침대', 100, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        
        -- 의자 (12)
        ('사무용 의자', 12, 80000.00, '허먼밀러', '인체공학적 사무용 의자', 35, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('게이밍 의자', 12, 120000.00, 'Secretlab', '게이밍 의자', 20, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('식탁 의자', 12, 45000.00, '이케아', '식탁용 의자 4개 세트', 30, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('안락 의자', 12, 150000.00, '이케아', '안락 의자', 15, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        ('바 의자', 12, 25000.00, '이케아', '바 스툴', 50, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop'),
        
        -- 침대 (13)
        ('퀸사이즈 침대', 13, 300000.00, '시몬스', '퀸사이즈 침대 프레임', 15, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ('킹사이즈 침대', 13, 400000.00, '시몬스', '킹사이즈 침대 프레임', 10, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ('싱글 침대', 13, 150000.00, '이케아', '싱글 침대 프레임', 25, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ('침대 매트리스', 13, 200000.00, '시몬스', '퀸사이즈 매트리스', 20, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ('침대 커버', 13, 50000.00, '이케아', '침대 커버 세트', 40, 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=600&h=600&fit=crop'),
        ...
        ('레몬 5개', 14, 3000.00, '농협', '신선한 레몬 5개', 200, 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=600&fit=crop'),
        
        -- 채소 (15)
        ('유기농 당근 500g', 15, 3000.00, '농협', '유기농 당근 500g', 150, 'https://images.unsplash.com/photo-1447175008436-170170753d52?w=600&h=600&fit=crop'),
        ...
        ('양파 1kg', 15, 2000.00, '농협', '국내산 양파 1kg', 300, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&h=600&fit=crop'),
        ('감자 1kg', 15, 2500.00, '농협', '국내산 감자 1kg', 250, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&h=600&fit=crop'),
        ('상추 200g', 15, 1500.00, '농협', '신선한 상추 200g', 200, 'https://images.unsplash.com/photo-1622205313162-be1d5716a43b?w=600&h=600&fit=crop'),
        ...
        ('고구마 1kg', 15, 4000.00, '농협', '국내산 고구마 1kg', 100, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&h=600&fit=crop'),
        ...
        ('돼지고기 목살 500g', 16, 8000.00, '농협', '신선한 돼지고기 목살 500g', 100, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('닭가슴살 1kg', 16, 12000.00, '농협', '무항생제 닭가슴살 1kg', 80, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('양고기 500g', 16, 30000.00, '농협', '프리미엄 양고기 500g', 30, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('오리고기 1kg', 16, 15000.00, '농협', '신선한 오리고기 1kg', 60, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('소고기 다짐육 500g', 16, 18000.00, '농협', '소고기 다짐육 500g', 70, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('돼지고기 삼겹살 1kg', 16, 22000.00, '농협', '돼지고기 삼겹살 1kg', 90, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop'),
        ('닭다리 1kg', 16, 10000.00, '농협', '닭다리 1kg', 110, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop');
